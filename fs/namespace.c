 ...
 * that are unshared by ksu process (Adapted for Kernel 4.19)
 */
 ...
 * that is mounted or single cloned by ksu process (Adapted for Kernel 4.19)
 */
...
#ifdef CONFIG_KSU_SUSFS_SUS_MOUNT
	if (mnt && mnt->mnt_id >= DEFAULT_KSU_MNT_ID &&
