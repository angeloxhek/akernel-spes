...
if [ -f "$kernel" ]; then
	...
	sed -i 's/kernel.string=.*/kernel.string=AKernel-clean-v1.0.0/g' AnyKernel3/anykernel.sh
	...
	sed -i 's/message.word=.*/message.word=A basic kernel/g' AnyKernel3/anykernel.sh
